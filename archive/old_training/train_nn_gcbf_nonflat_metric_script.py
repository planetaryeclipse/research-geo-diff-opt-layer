...
from diff_mfld_optim.geometry.metric import RnMetricField, MetricField
...
# this non-euclidean metric increases control effort to continue increasing the
# linear velocity and heavily punishes attempting to take further angular input
# when already at a high linear acceleration (would lead to harder control) but
# we assign no cost to move between linear and angular control which would
...
training_data_dir = pathlib.Path("../results/geo_results/nonflat_metric")
